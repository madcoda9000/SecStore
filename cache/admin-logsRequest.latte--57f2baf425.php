...
/** source: admin/logsRequest.latte */
final class Template_57f2baf425 extends Latte\Runtime\Template
{
	public const Source = 'admin/logsRequest.latte';
...
<div class="container py-4" style="flex:1">
    <h1 class="mb-5">View - Requestlogs</h1>
...
<!-- include js -->
<script src="/js/admin/logsRequest.latte-min.js"></script>
