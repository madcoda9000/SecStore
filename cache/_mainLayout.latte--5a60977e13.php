...
final class Template_5a60977e13 extends Latte\Runtime\Template
{
...
<html lang="en">
    <head>        
        ...
        <link rel="stylesheet" href="/css/_mainLayout.latte-min.css" />
        ...
        <footer class="footer bg-dark text-light">
            <div class="container py-3">
                <div class="doubbleDivContainer">
                    <div class="divLeft" style="color:var(--bs-secondary-text-emphasis);">
                        <p>&copy; 2025 Fancy Website. Alle Rechte vorbehalten.</p>
                    </div>
                    <div class="divRight" style="color:var(--bs-secondary-text-emphasis);">
                        Sessiontimeout in:&nbsp;<span id="remainingSessionTime" style="color:var(--bs-warning-text-emphasis);">00:00:00</span>
                    </div>
                </div>                 
            </div>
        </footer>
