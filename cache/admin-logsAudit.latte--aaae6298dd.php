...
/** source: admin/logsAudit.latte */
final class Template_aaae6298dd extends Latte\Runtime\Template
{
	public const Source = 'admin/logsAudit.latte';
...
<div class="container py-4" style="flex:1">
    <h1 class="mb-5">View - Auditlogs</h1>
    ...
    <div id="logCardsBody" class="d-block d-md-none"></div>
...
<!-- include js -->
<script src="/js/admin/logsAudit.latte-min.js"></script>
