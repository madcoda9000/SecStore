...
/** source: admin/logsError.latte */
final class Template_f48d5a2470 extends Latte\Runtime\Template
{
	public const Source = 'admin/logsError.latte';
...
<div class="container py-4" style="flex:1">
    <h1 class="mb-5">View - Errorlogs</h1>
...
<script src="/js/admin/logsError.latte-min.js"></script>
