...
/** source: admin/logsMail.latte */
final class Template_a306066708 extends Latte\Runtime\Template
{
	public const Source = 'admin/logsMail.latte';
...
<div class="container py-4" style="flex:1">
    <h1 class="mb-5">View - Maillogs</h1>
...
<!-- include js -->
<script src="/js/admin/logsMail.latte-min.js"></script>
