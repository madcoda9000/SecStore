...
/** source: admin/logsDb.latte */
final class Template_e7c0f00cc7 extends Latte\Runtime\Template
{
	public const Source = 'admin/logsDb.latte';
...
<div class="container py-4" style="flex:1">
    <h1 class="mb-5">View - Databaselogs</h1>
...
<!-- include js -->
<script src="/js/admin/logsDb.latte-min.js"></script>
