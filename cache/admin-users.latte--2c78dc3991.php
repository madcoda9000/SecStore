...
final class Template_2c78dc3991 extends Latte\Runtime\Template
{
...
';
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
		...
		echo '" placeholder="Suche Benutzer" class="form-control form-control-sm w-auto">
            ...
            <button type="button" class="btn btn-success" onclick="window.location.href=\'/admin/showCreateUser\'">Create User</button>
            </div>
        </form>
    </div>
...
';
		foreach ($users as $use) /* line 154 */ {
			...
			echo LR\Filters::escapeHtmlAttr($use->id) /* line 162 */;
...
';
    ...
    <div class="d-flex justify-content-between align-items-center mt-3">
        <div>Seite ';
		echo LR\Filters::escapeHtmlText($page) /* line 172 */;
		echo ' von ';
		echo LR\Filters::escapeHtmlText(ceil($totalUsers / $pageSize)) /* line 172 */;
		echo '</div>
        <div>
';
		if ($page > 1) /* line 174 */ {
			echo '                <a href="?page=';
			echo LR\Filters::escapeHtmlAttr($page - 1) /* line 175 */;
			echo '&pageSize=';
			echo LR\Filters::escapeHtmlAttr($pageSize) /* line 175 */;
			echo '&search=';
			echo LR\Filters::escapeHtmlAttr($search) /* line 175 */;
			echo '" class="btn btn-outline-secondary btn-sm">
                    Vorherige
                </a>
';
		}
		if ($page * $pageSize < $totalUsers) /* line 179 */ {
			echo '                <a href="?page=';
			echo LR\Filters::escapeHtmlAttr($page + 1) /* line 180 */;
			echo '&pageSize=';
			echo LR\Filters::escapeHtmlAttr($pageSize) /* line 180 */;
			echo '&search=';
			echo LR\Filters::escapeHtmlAttr($search) /* line 180 */;
			echo '" class="btn btn-outline-secondary btn-sm">
                    Nächste
                </a>
';
