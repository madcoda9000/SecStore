...
class ProfileController
{
    ...
    /**
     * Starts the 2fa setup process for the current user.
     *
     * This method starts the 2fa setup process for the current user by
     * generating a new secret and enabling mfa setup for the user.
     *
